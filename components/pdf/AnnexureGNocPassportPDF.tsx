    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 25 }}>
          ...
          <View style={styles.photoBox}>
            {applicantPhoto ? (
              ...
              <Text>Applicant's photo to be attested by Certifying authority</Text>
            )}
          </View>
        </View>
        ...
        <Text style={styles.para}>
          <Text style={styles.bold}>{applicantName}</Text>, Son of{" "}
          <Text style={styles.bold}>{fatherName}</Text>, who is an Indian national, is employed at the Indian
          Institute of Technology (IIT) Indore, Madhya Pradesh, India, since{" "}
          <Text style={styles.bold}>{doj}</Text>, as an Assistant Professor in the Department of{" "}
          <Text style={styles.bold}>{department}</Text>.
        </Text>

        <Text style={styles.para}>
          This organization has no objection to the renewal of his Indian Passport no.{" "}
          <Text style={styles.bold}>{passportNumber}</Text>.
        </Text>

        <Text style={styles.para}>This NOC will be valid for six months from the date of issue.</Text>
